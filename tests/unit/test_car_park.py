...
class TestCarPark:
    ...
    def test_with_cost(self):
        ...
        assert cp.daily_cost is not None
...
class TestCarParkRegistry:
    ...
    def test_no_csv_file_returns_empty(self):
        registry = CarParkRegistry(rates_path=Path("/tmp/nonexistent_parking_rates.csv"))
        registry._load()
    ...
    # lucidlint: ignore fakefs deterministic tmp_path test — the house testing standard (no pyfakefs)
    def test_lookup_known_station_by_name(self, tmp_path):
    ...
    # lucidlint: ignore fakefs deterministic tmp_path test — the house testing standard (no pyfakefs)
    def test_lookup_free_station(self, tmp_path):
        csv_path = tmp_path / "parking_rates.csv"
        csv_path.write_text("station_name,crs,daily_cost_gbp\nMarlow,MLW,0.0\n")
    ...
    # lucidlint: ignore fakefs deterministic tmp_path test — the house testing standard (no pyfakefs)
    def test_lookup_unknown_station(self, tmp_path):
        csv_path = tmp_path / "parking_rates.csv"
        csv_path.write_text("station_name,crs,daily_cost_gbp\nMarlow,MLW,0.0\n")
    ...
    # lucidlint: ignore fakefs deterministic tmp_path test — the house testing standard (no pyfakefs)
    def test_lookup_blank_cost_returns_car_park_with_none_cost(self, tmp_path):
        csv_path = tmp_path / "parking_rates.csv"
        csv_path.write_text("station_name,crs,daily_cost_gbp\nMarlow,MLW,\n")
    ...
    # lucidlint: ignore fakefs deterministic tmp_path test — the house testing standard (no pyfakefs)
    def test_lookup_by_crs_fallback(self, tmp_path):
    ...
    # lucidlint: ignore fakefs deterministic tmp_path test — the house testing standard (no pyfakefs)
    def test_lookup_by_crs_missing(self, tmp_path):
    ...
    # lucidlint: ignore fakefs deterministic tmp_path test — the house testing standard (no pyfakefs)
    def test_load_handles_old_csv_format(self, tmp_path):
    ...
    # lucidlint: ignore fakefs deterministic tmp_path test — the house testing standard (no pyfakefs)
    def test_load_handles_new_csv_format(self, tmp_path):
    ...
    # lucidlint: ignore fakefs deterministic tmp_path test — the house testing standard (no pyfakefs)
    def test_persist_results_writes_to_csv(self, tmp_path):
        ...
        registry2 = CarParkRegistry(rates_path=csv_path)
    ...
    # ── APCOA methods (inject the internal scraper via constructor seam) ──

    @pytest.mark.asyncio
    # lucidlint: ignore fakefs deterministic tmp_path test — the house testing standard (no pyfakefs)
    async def test_load_costs_known_station_no_cost(self, tmp_path):
        ...
        result = await lookup.load_costs(car_park, station)
    ...
    @pytest.mark.asyncio
    # lucidlint: ignore fakefs deterministic tmp_path test — the house testing standard (no pyfakefs)
    async def test_load_costs_apcoa_returns_none(self, tmp_path):
    ...
    @pytest.mark.asyncio
    # lucidlint: ignore fakefs deterministic tmp_path test — the house testing standard (no pyfakefs)
    async def test_add_nearest_car_park_for_unknown_station(self, tmp_path):
        ...
        result = await lookup.add_nearest_car_park_for(station)
        assert result.succeeded
    ...
    @pytest.mark.asyncio
    # lucidlint: ignore fakefs deterministic tmp_path test — the house testing standard (no pyfakefs)
    async def test_add_nearest_car_park_apcoa_returns_none(self, tmp_path):
