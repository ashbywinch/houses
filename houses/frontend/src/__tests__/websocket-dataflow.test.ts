        ...
        ws.onmessage?.({
          data: JSON.stringify({
            ...
            data: {
              ...
              schools: {
                primary: { school: { succeeded: true, value: { name: 'WS Primary', ofsted: 'Good', distance_km: 1, url: '' }, error: null, provenance: { label: 'ws' } } },
        ...
        ws.onmessage?.({
          data: JSON.stringify({
            ...
            data: {
              ...
              schools: {
                primary: { school: { succeeded: true, value: { name: 'Empty Ofsted Primary', ofsted: '', distance_km: 1, url: '' }, error: null, provenance: { label: 'ws' } } },
              },
            },
          }),
        })
  ...
  it('populates store from API response with empty ofsted without error', async () => {
    ...
    const apiData: Record<string, any> = {
      'prop-1': {
        ...
        commutes: {},
        schools: {
          primary: { school: { succeeded: true, value: { name: 'API Primary', ofsted: 'Good', distance_km: 1, url: '' }, error: null, provenance: { label: 'api' } } },
          secondary: { school: { succeeded: false, value: null, error: null, provenance: { label: 'api' } } },
        },
        walkability: { succeeded: true, value: { walk_to_town_minutes: 10 }, error: null, provenance: { label: 'api' } },
      ...
      'prop-2': {
        ...
        schools: {
          primary: { school: { succeeded: true, value: { name: 'Empty Ofsted School', ofsted: '', distance_km: 2, url: '' }, error: null, provenance: { label: 'api' } } },
          secondary: { school: { succeeded: false, value: null, error: null, provenance: { label: 'api' } } },
        },
