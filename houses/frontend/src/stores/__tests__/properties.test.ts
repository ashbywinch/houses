...
function mockDetail(rid: string): PropertyDetail {
  return {
    ...
    affordability: {
      stamp_duty: { succeeded: true, value: 0, error: null, provenance: { label: 'test' } },
      council_tax: { succeeded: false, value: null, error: null, provenance: { label: 'test' } },
      monthly_mortgage: { succeeded: true, value: 0, error: null, provenance: { label: 'test' } },
      monthly_sinking_fund: { succeeded: true, value: 0, error: null, provenance: { label: 'test' } },
      ...
      total_monthly_housing_cost: { succeeded: true, value: 0, error: null, provenance: { label: 'test' } },
    },
    area: {
